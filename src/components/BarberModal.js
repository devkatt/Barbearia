...
export default ({ show, setShow, user, sevice }) => {
    const navigation = useNavigation();

    const [setSelectedYear, setSelectedYear] = useState(0);
    const [setSelectedMonth, setSelectedMonth] = useState(0);
    const [setSelectedDay, setSelectedDay] = useState(0);
    const [setSelectedHour, setSelectedHour] = useState(null);
    const [listDays, listDays] = useState([]);
    const [listHours, listHours] = useState([]);
    ...
    const handleLeftDateClick = () => {
        let mountDate = new Date(selectedYear, setSelectedMonth, 1);
